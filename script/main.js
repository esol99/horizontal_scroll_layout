...
$(window).scroll(function(){
  let sPos = $(this).scrollLeft(); //가로스크롤 값 변수에 담기
...
$('.gnb li a').click(function(){
  ...
  //해당하는 adml href 속성 값을 변수에 담기
  let id_value = $(this).attr('href');
  console.log(id_value); //증명하기

  //가져온 sec1, sec2, sec3, sec4의 위치값을 왼쪽에 맞추기
  let secOffset = $(id_value).offset().left; //왼쪽으로부터 떨어진 값
...
$('main section').each(function(){
  ...
  $(this).on('mousewheel',function(e){
    ...
    var delta = 0;
    var moveTop = null;
    var boxMax = $("main section").length - 1; //section의 개수가 3임
    var winEvent = "";
    console.log(boxMax);
